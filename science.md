...
### **Question 9**
**An isotropic source of 2 candela produces light flux equal to:**  
*2 कैंडेला का एक समदिश (Isotropic) स्रोत कितना प्रकाश फ्लक्स उत्पन्न करता है?*

📋 **Topic:** Optics – Photometry (Light & Illumination)  
📋 **विषय:** प्रकाशिकी – प्रकाश एवं प्रकाशन
...
✅ **Correct Answer:** **C. 8π lumen**

---

### **Question 10**
**The spray bottles used as window or household cleaner or perfume sprayer work on:**  
*खिड़की साफ़ करने वाले, घरेलू क्लीनर या परफ्यूम स्प्रे किस सिद्धांत पर कार्य करते हैं?*

📋 **Topic:** Laws of Motion & Fluid Mechanics  
📋 **विषय:** तरल गतिकी (Fluid Mechanics)

**Options:**  
- **A.** Capillary action *(केशिकीय क्रिया)*  
- **B.** Bernoulli's principle *(बर्नौली का सिद्धांत)*  
...
### **Question 11**
**The trade name of basic lead carbonate is:**  
*बेसिक लेड कार्बोनेट का व्यापारिक नाम क्या है?*

📋 **Topic:** Inorganic Chemistry – Important Compounds  
📋 **विषय:** अकार्बनिक रसायन – महत्वपूर्ण यौगिक

**Options:**  
- **A.** White lead *(सफेद सीसा)*  
- **B.** Red lead *(लाल सीसा)*  
- **C.** Litharge  
- **D.** More than one of the above *(उपरोक्त में से एक से अधिक)*  
- **E.** None of the above *(इनमें से कोई नहीं)*

✅ **Correct Answer:** **A. White lead**

---

### **Question 12**
**Which of the following elements has the largest atomic radius?**  
*निम्नलिखित में से किस तत्व की परमाणु त्रिज्या (Atomic Radius) सबसे अधिक है?*

📋 **Topic:** Periodic Table – Periodic Properties  
📋 **विषय:** आवर्त सारणी – आवर्त गुण

**Options:**  
- **A.** Lithium *(लिथियम)*  
- **B.** Beryllium *(बेरीलियम)*  
- **C.** Boron *(बोरॉन)*  
- **D.** More than one of the above *(उपरोक्त में से एक से अधिक)*  
- **E.** None of the above *(इनमें से कोई नहीं)*
...
*पौधों में प्रकाश-अवधि प्रभाव (Photoperiodism) की खोज किसने की?*

📋 **Topic:** Plant Physiology – Growth & Development  
📋 **विषय:** पादप शरीर क्रिया विज्ञान – वृद्धि एवं विकास
...
✅ **Correct Answer:** **A. Garner and Allard**
...
*केरल की साइलेंट वैली को संरक्षित क्यों किया गया है?*

📋 **Topic:** Ecology – Biodiversity & Conservation  
📋 **विषय:** पारिस्थितिकी – जैव विविधता एवं संरक्षण

**Options:**  
- **A.** It contains very rare species of plants and animals *(इसमें दुर्लभ पौधों और जीवों की प्रजातियाँ पाई जाती हैं)*  
- **B.** The soil is rich in minerals *(मिट्टी खनिजों से भरपूर है)*  
- **C.** The land was extensively used for agriculture *(भूमि का व्यापक रूप से कृषि उपयोग हुआ)*  
- **D.** More than one of the above *(उपरोक्त में से एक से अधिक)*  
- **E.** None of the above *(इनमें से कोई नहीं)*

✅ **Correct Answer:** **A. It contains very rare species of plants and animals**

---

### **Question 15**
**During normal respiration in a mammal, the diaphragm is:**  
*स्तनधारी जीव में सामान्य श्वसन के दौरान डायाफ्राम की स्थिति क्या होती है?*

📋 **Topic:** Human Physiology – Respiration  
📋 **विषय:** मानव शरीर क्रिया विज्ञान – श्वसन

**Options:**  
- **A.** Arched *(धनुषाकार)*  
- **B.** Flattened *(चपटा)*  
- **C.** Lowered *(नीचे की ओर गया हुआ)*  
- **D.** More than one of the above *(उपरोक्त में से एक से अधिक)*  
- **E.** None of the above *(इनमें से कोई नहीं)*

✅ **Correct Answer:** **B. Flattened**

---

### **Question 16**
**The most important cell type associated with the immunity of the body is:**  
*शरीर की प्रतिरक्षा (Immunity) से संबंधित सबसे महत्वपूर्ण कोशिका कौन-सी है?*

📋 **Topic:** Human Physiology – Immune System  
📋 **विषय:** मानव शरीर क्रिया विज्ञान – प्रतिरक्षा तंत्र
...
### **Question 17**
**The Sun observation point of Aditya-L1 satellite is:**  
*आदित्य-L1 उपग्रह सूर्य का अवलोकन किस बिंदु से करता है?*
...
### **Question 18**
**Ginger is an underground stem and not a root because:**  
*अदरक भूमिगत तना (Stem) है, जड़ (Root) नहीं, क्योंकि—*

📋 **Topic:** Botany – Morphology of Plants  
📋 **विषय:** वनस्पति विज्ञान – पादप आकारिकी

**Options:**  
- **A.** It stores food material *(यह भोजन संग्रह करता है)*  
- **B.** It has nodes and internodes *(इसमें पर्व एवं अंतर्पर्व होते हैं)*  
- **C.** It lacks chlorophyll *(इसमें क्लोरोफिल नहीं होता)*  
- **D.** More than one of the above *(उपरोक्त में से एक से अधिक)*  
- **E.** None of the above *(इनमें से कोई नहीं)*

✅ **Correct Answer:** **B. It has nodes and internodes**

---

### **Question 19**
**The focal length of a convex lens is f = 10 cm. When immersed in water, it will act as:**  
*एक उत्तल लेंस की फोकस दूरी 10 सेमी है। पानी में डुबाने पर यह किस प्रकार कार्य करेगा?*

📋 **Topic:** Optics – Lenses  
📋 **विषय:** प्रकाशिकी – लेंस

**Options:**  
- **A.** Convex lens with f = 10 cm  
- **B.** Concave lens with f = 10 cm  
- **C.** Convex lens with f > 10 cm  
- **D.** More than one of the above *(उपरोक्त में से एक से अधिक)*  
- **E.** None of the above *(इनमें से कोई नहीं)*

✅ **Correct Answer:** **C. Convex lens with f > 10 cm**
...
*यद्यपि पानी दृश्य प्रकाश के लिए पारदर्शी होता है, फिर भी जल की सूक्ष्म बूंदों से बने कोहरे में दूर की वस्तुएँ दिखाई नहीं देतीं। इसका कारण है—*

📋 **Topic:** Optics – Scattering of Light  
📋 **विषय:** प्रकाशिकी – प्रकाश का प्रकीर्णन

**Options:**  
- **A.** Fine drops of water are opaque to visible light *(जल की सूक्ष्म बूंदें दृश्य प्रकाश के लिए अपारदर्शी होती हैं)*  
- **B.** Most of the light is scattered to create apparent opacity *(अधिकांश प्रकाश का प्रकीर्णन हो जाता है जिससे अपारदर्शिता प्रतीत होती है)*  
- **C.** Light rays suffer total internal reflection and cannot reach the eyes *(प्रकाश किरणों का पूर्ण आंतरिक परावर्तन हो जाता है)*  
- **D.** More than one of the above *(उपरोक्त में से एक से अधिक)*  
- **E.** None of the above *(इनमें से कोई नहीं)*

✅ **Correct Answer:** **B. Most of the light is scattered**

---

### **Question 21**
**Monochromatic light enters from one medium to another. Which property does not change?**  
*एकरंगी (Monochromatic) प्रकाश जब एक माध्यम से दूसरे माध्यम में प्रवेश करता है, तो कौन-सा गुण नहीं बदलता?*

📋 **Topic:** Wave Optics – Refraction  
📋 **विषय:** तरंग प्रकाशिकी – अपवर्तन
